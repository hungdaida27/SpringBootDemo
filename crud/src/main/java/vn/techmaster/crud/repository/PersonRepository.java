...
public class PersonRepository {
    ...
    public PersonRepository() {
        people.add(new Person(1, "Nguyen Ngoc Hung", "Developer", true, "1994-04-07"));
        people.add(new Person(2, "Le Thi Ngoc Dung", "Developer", false, "1995-04-07"));
        people.add(new Person(3, "Nguyen Ngoc Hung", "Developer", true, "1994-04-07"));
    }
